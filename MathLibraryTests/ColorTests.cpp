...
namespace MathLibraryTests
{
	...
	public:
		...
		TEST_METHOD(GreenTest)
		{
			Colour actual = Colour((Byte)94, (Byte)0x0, (Byte)0x0, (Byte)0x0);
			actual = actual.shiftRedToGreen();
			Assert::AreEqual((Byte)94, actual.getGreen());
			Assert::AreEqual((Byte)0, actual.getRed());
		}
	};
}
